// Please, include it only from TestAgency.cu
#pragma once
                   ...
                   float risk_free, float volatility, int n)
{
  ...
  // auto complete ~ bulk_invoke(cuda::par)
}
...
using namespace test_agency;

TEST_THETIS_PARALLEL(TestAgency01) {
  int n = 4000000;
