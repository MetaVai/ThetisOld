...
execute_process(
    COMMAND ${Julia_EXECUTABLE} --startup-file=no -E "julia_include_dir = joinpath(ENV[\"JULIA_HOME\"],\"include\",\"julia\")\n
        if !isdir(julia_include_dir)  # then we're running directly from build\n
        julia_base_dir_aux = splitdir(splitdir(ENV[\"JULIA_HOME\"])[1])[1]  # useful for running-from-build\n
...
execute_process(
COMMAND ${Julia_EXECUTABLE} --startup-file=no -E "using Libdl;\nabspath(dirname(Libdl.dlpath(\"libjulia\")))"
...
execute_process(
COMMAND ${Julia_EXECUTABLE} --startup-file=no -E "ENV[\"JULIA_HOME\"]"
