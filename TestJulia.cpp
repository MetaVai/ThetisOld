...
// if you want more ~ https://julialang.github.io/PackageCompiler.jl/dev/devdocs/binaries_part_2/
...
TEST_THETIS(TestJulia01) {
#if defined(ENABLE_JULIA) && !defined(_DEBUG)
...
#else
    std::cerr << " no julia plugin " << std::endl;
#endif
}
